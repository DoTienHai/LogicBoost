...
@admin_questions_bp.route("/question/new", methods=["POST"])
@login_required
@require_permission("create_questions")
def add_question_post():
    ...
    try:
        ...
        return redirect(url_for("admin_questions.index"))
    except Exception as e:
        db.session.rollback()
        return render_template(
            "admin/question_form.html",
...
@admin_questions_bp.route("/question/<int:question_id>/edit", methods=["GET"])
@login_required
...
@admin_questions_bp.route("/question/<int:question_id>/edit", methods=["POST"])
@login_required
@require_permission("edit_questions")
...
@admin_questions_bp.route("/import", methods=["GET"])
@login_required
...
@admin_questions_bp.route("/import", methods=["POST"])
@login_required
@require_permission("import_excel")
...
@admin_questions_bp.route("/question/<int:question_id>/delete", methods=["POST"])
@login_required
...
@admin_questions_bp.route("/import/template")
def download_template():
    ...
    if not os.path.exists(template_path):
        ...
        return redirect(url_for("admin_questions.import_page_get"))
